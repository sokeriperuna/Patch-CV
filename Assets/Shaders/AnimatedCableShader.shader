Shader "Unlit/AnimatedCableShader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                v.uv.x *= o.magMap.x; // Set x-tiling to magnitude
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                float2 uv = float2(i.uv.x - frac(_Time.y * _AnimateSpeed), i.uv.y); // We offset repatedly with frac to make it look like its looping
                ...
                UNITY_APPLY_FOG(i.fogCoord, compositeColor);
